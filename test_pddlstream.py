...
def pddlstream_from_problem(problem, exp_dir=__file__, collisions=True, teleport=False):
    robot = problem.robot
...
def main(exp_dir=__file__, partial=False, defer=False, verbose=True):
    ...
    pddlstream_problem = pddlstream_from_problem(problem, exp_dir=exp_dir, collisions=not args.cfree, teleport=args.teleport)
