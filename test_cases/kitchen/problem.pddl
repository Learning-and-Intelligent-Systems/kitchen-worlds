...
(define
  ...
  (:init
	...
	(pose veggiecabbage#1 p0=(0.7, 4.8, 0.838, 0.764))
	(pose braiserlid#1 p1=(0.55, 8.181, 0.821, 2.525))
	(pose meatturkeyleg#1 p2=(0.7, 8.9, 0.844, 2.9))

	(atpose veggiecabbage#1 p0=(0.7, 4.8, 0.838, 0.764))
	(atpose braiserlid#1 p1=(0.55, 8.181, 0.821, 2.525))
	(atpose meatturkeyleg#1 p2=(0.7, 8.9, 0.844, 2.9))
	...
	(aconf right aq112=(-2.135, 1.296, -3.75, -0.15, -10000, -0.1, -10000))

	(ataconf left aq208=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq112=(-2.135, 1.296, -3.75, -0.15, -10000, -0.1, -10000))

	(defaultconf left aq208=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(defaultconf right aq112=(-2.135, 1.296, -3.75, -0.15, -10000, -0.1, -10000))
	(supported meatturkeyleg#1 p2=(0.7, 8.9, 0.844, 2.9) counter#1--indigo_tmp)
