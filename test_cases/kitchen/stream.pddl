(define (stream pr2-tamp)
  ...
  ;)
    ...
    (:stream inverse-kinematics-ungrasp-handle
      ...
      :outputs (?aq2 ?t)
      :certified (and (AConf ?a ?aq2) (ATraj ?t) (KinUngraspHandle ?a ?o ?p ?g ?q ?aq1 ?aq2 ?t))
    )
    ...
    (:stream plan-base-pull-door-handle
      ...
      :domain (and (Controllable ?a) (Door ?o) (Position ?o ?p1) (Position ?o ?p2) (HandleGrasp ?o ?g) (BConf ?q1) (AConf ?a ?aq1) (IsClosedPosition ?o ?p1) (IsOpenedPosition ?o ?p2))
      :outputs (?q2 ?bt ?aq2 ?at)
      :certified (and (BConf ?q2) (UngraspBConf ?q2) (BTraj ?bt) (AConf ?a ?aq2) (ATraj ?at) (KinPullDoorHandle ?a ?o ?p1 ?p2 ?g ?q1 ?q2 ?bt ?aq1 ?aq2 ?at))
    )
    (:stream plan-arm-turn-knob-handle
      :inputs (?a ?o ?p1 ?p2 ?g ?q ?aq1)
      :domain (and (Controllable ?a) (Knob ?o) (Position ?o ?p1) (Position ?o ?p2) (HandleGrasp ?o ?g) (BConf ?q) (AConf ?a ?aq1) (IsClosedPosition ?o ?p1) (IsOpenedPosition ?o ?p2))
      :outputs (?aq2 ?at)
    ...
    (:stream plan-base-pull-marker-random
      ...
      :outputs (?p2 ?q2 ?p4 ?t)
      :certified (and (Pose ?o ?p2) (BConf ?q2) (Pose ?o2 ?p4) (BTraj ?t) (KinPullMarkerRandom ?a ?o ?p1 ?p2 ?g ?q1 ?q2 ?o2 ?p3 ?p4 ?t))
    )
